...
namespace LeagueSandbox.GameServer.Logic.Content
{
    ...
    public class ItemType : ChampionStatMod
    {
        ...
        private ItemType(ItemManager owner, ItemContentCollectionEntry itemInfo)
        {
            ...
            HealthPoints = new StatMod();
            HealthRegeneration = new StatMod();
            AttackDamage = new StatMod();
            AbilityPower = new StatMod();
            CriticalChance = new StatMod();
            Armor = new StatMod();
            MagicResist = new StatMod();
            AttackSpeed = new StatMod();
            ArmorPenetration = new StatMod();
            MagicPenetration = new StatMod();
            ManaPoints = new StatMod();
            ManaRegeneration = new StatMod();
            LifeSteal = new StatMod();
            SpellVamp = new StatMod();
            Tenacity = new StatMod();
            Size = new StatMod();
            AttackRange = new StatMod();
            MovementSpeed = new StatMod();
            GoldPerSecond = new StatMod();
            CriticalDamage = new StatMod();
        }
